...
class CampanyPageLocators:
    ...
    CREATED_CAMPANY = (By.XPATH, "//button[text()='Кампания 2024-13-12']")
    ...
    BUTTON_EDIT_CAMPANY_OPEN_GROUPS = (By.XPATH, "//div[@data-testid='menu-item']//span[text()='Группа 2024-12-12']")
    BUTTON_EDIT_CAMPANY_OPEN_ADV = (By.XPATH, "//div[@data-testid='menu-item']//span[text()='Объявление 2024-12-12']")
    BUTTON_EDIT_CAMPANY_SUBMIT = (By.XPATH, "//button[@data-testid='submit']")
    DIV_EDIT_CAMPANY_NEW_BUDGET = (By.XPATH, "//div[text()='121,00 ₽']")
    DIV_EDIT_BUDGET_NEW_CAMPANY_NAME = (By.XPATH, "//button[text()='Кампания 2024-12-12']")
